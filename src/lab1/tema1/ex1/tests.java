...
/**
 * <h1>Testele pentru clasa KSpecial</h1>
 * @author Daniel Filip
 */
...
public class tests {
    ...
    public void testIsKSpecialTrue() {
        ...
        int[] A1 = {1, 0, 1, 1, 0, 0};
        int n1 = A1.length;
        assertTrue(KSpecial.KSpecial(A1, n1, 3));
    }
    ...
    public void testIsKSpecialFalse() {
        ...
        int[] A2 = {1, 1, 0, 0, 1, 0};
        int n2 = A2.length;
        assertFalse(KSpecial.KSpecial(A2, n2, 3));
    }
    ...
    public void testIsKSpecialEdgeCaseTrue() {
        ...
        int[] A3 = {1, 1, 1};
        int n3 = A3.length;
        assertTrue(KSpecial.KSpecial(A3, n3, 3));
    }
    ...
    public void testIsKSpecialEdgeCaseFalse() {
        ...
        int[] A4 = {1, 0, 0};
        int n4 = A4.length;
        assertFalse(KSpecial.KSpecial(A4, n4, 2));
    }
    ...
    public void testIsKSpecialShortTrue() {
        ...
        int[] A5 = {1, 0, 1};
        int n5 = A5.length;
        assertTrue(KSpecial.KSpecial(A5, n5, 2));
    }
    ...
    public void testIsKSpecialTooManyZeros() {
        ...
        int[] A6 = {1, 0, 0, 1};
        int n6 = A6.length;
        assertFalse(KSpecial.KSpecial(A6, n6, 2));
    }
}
